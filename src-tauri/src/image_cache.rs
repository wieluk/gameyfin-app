...
/// A cached image's file name: stable across restarts, unable to escape the cache
/// directory, and hashed so two server paths cannot collapse onto one file.
...
mod tests {
    ...
    #[test]
    fn entry_names_are_stable_for_a_path_and_unique_between_paths() {
        assert_eq!(entry_name("/images/cover/7"), entry_name("images/cover/7"));
        assert_ne!(entry_name("images/a/b"), entry_name("images/a_b"));
    }
