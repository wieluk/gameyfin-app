...
/**
 * A strip saying a new version exists.
 *
 * Shown for every package format, because the check works everywhere even where the
 * install does not. What the button offers is the difference: the formats that own their
 * own files install it, and the ones the system package manager owns get sent to the
 * release page instead of a button that would silently do nothing.
 */
