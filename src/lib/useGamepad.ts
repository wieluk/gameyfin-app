/**
 * Binding controller events to the interface, mounted once. What a button does is decided from
 * what is on screen, so no view needs to know a controller exists.
 */
