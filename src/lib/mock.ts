...
const answers: Record<string, unknown> = {
  ...
  scan_this_pc: [],
  skip_save_sync: null,
  save_locations: { savesRoot: null, staging: null, prefixHome: null, prefixDriveC: null, installDir: null, home: null, savesInPrefix: false, detected: [], suggested: [] },
  save_paths: { customPaths: [], redirects: [], crossOs: false },
  reset_settings: null,
  list_prefixes: [],
  rescan_library: 0,
  save_state: { kind: "off" },
